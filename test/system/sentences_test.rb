...
class SentencesTest < ApplicationSystemTestCase
  ...
  test "creating a Sentence" do
    ...
    fill_in "English sentence", with: @sentence.english_sentence
    fill_in "Pronunciation sentence", with: @sentence.pronunciation_sentence
    fill_in "Translation sentence", with: @sentence.translation_sentence
    fill_in "Transliteration sentence", with: @sentence.transliteration_sentence
    fill_in "Word", with: @sentence.word_id
